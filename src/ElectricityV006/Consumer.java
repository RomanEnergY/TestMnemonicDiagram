...
//        listener.getElectricityConnection().connect(listener, this.contact_p1);
...
//    @Override
//    public void checkStatusObject(String name, ContactNumber contactNumber, EventElectricity eventElectricity) {
...
//    }
    ...
    public void connect(Contact contact_connect, ArrayList<Contact> contactArrayList) {
        System.out.println("Consumer:connect(Contact contact_connect, ArrayList<Contact> contactArrayList) contact_connect:" + contact_connect + ", contactArrayList:" + contactArrayList);
    }
