 ...
 */
public class ModelVN10kV extends ModelShape {

    public ModelVN10kV(String name, boolean isOn) {
        super(name, isOn);
    }
    ...
    protected final void setShapeObject(ArrayList<ShapeColor> shapeObject, Color colorObject) {
        ...
        shapeObject.add(new ShapeColor(
                new RoundRectangle2D.Double(-4.0f * ZOOM, -3.0f * ZOOM, 8.0f * ZOOM, 16.0f * ZOOM, 4.0f * ZOOM, 4.0f * ZOOM),
                colorObject));
    }
    ...
    protected final void setShapeFlag(ArrayList<ShapeColor> shapeFlag, Color colorFlag) {
        shapeFlag.add(new ShapeColor(
                new Ellipse2D.Double(-0.5f * ZOOM, -0.5f * ZOOM, 1 * ZOOM, 1 * ZOOM),
                colorFlag));

        shapeFlag.add(new ShapeColor(
                new Ellipse2D.Double(-0.5f * ZOOM, 9.5f * ZOOM, 1 * ZOOM, 1 * ZOOM),
                colorFlag));
    }
    ...
    @Override
    public Object clone() {
        return new ModelVN10kV(this.name, this.isOn());
    }
}
