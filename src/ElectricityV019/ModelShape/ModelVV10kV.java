...
public class ModelVV10kV extends ModelShape {
    ...
    protected final void setShapeObject(ArrayList<ShapeColor> shapeObject, Color colorObject) {
        shapeObject.add(new ShapeColor(
                new Rectangle2D.Double(-1.5 * ZOOM, -4.0 * ZOOM, 3.0 * ZOOM, 2.0 * ZOOM),
                colorObject));

        shapeObject.add(new ShapeColor(
                new Rectangle2D.Double(-7.0 * ZOOM, -2.5 * ZOOM, 14.0 * ZOOM, 15.0 * ZOOM),
                colorObject));

        shapeObject.add(new ShapeColor(
                new Rectangle2D.Double(-1.5 * ZOOM, 12.0 * ZOOM, 3.0 * ZOOM, 2.0 * ZOOM),
                colorObject));
    }
    ...
    @Override
    public Object clone() {
        return new ModelVV10kV(this.name, this.isOn());
    }
}
