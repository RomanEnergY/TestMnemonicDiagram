...
public class ObjectContact implements ElectricityConnection, ElectricityConsumer {
    ...
    public void connect(Contact contactEvent, Contact contactConnect) {
        System.out.println(this.getClass() + " public void connect(Contact contactEvent, Contact contactConnect) contactEvent=" + contactEvent + ", contactConnect=" + contactConnect);
     ...
     *
     * @param eventPathElectricCurrent передаваемый путь
    ...
    public void electricityOn(PathElectricCurrent eventPathElectricCurrent) throws CloneNotSupportedException {
        ...
        for (Contact contactConnect: this.contactConnectArrayList) {
            contactConnect.electricityOn(eventPathElectricCurrent);
        }
    }
    ...
    public void electricityOff(PathElectricCurrent eventPathElectricCurrent) throws CloneNotSupportedException {
        ...
        for (Contact contactConnect: this.contactConnectArrayList) {
            contactConnect.electricityOff(eventPathElectricCurrent);
        }
