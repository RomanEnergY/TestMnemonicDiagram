...
//                System.out.println(this.getClass() + " return objectContact_p2:" + objectContact_p2);
                return new VoltageTerminal(voltageTerminal.getEventElectricity(), objectContact_p2.getMainContact());
            }
        }
...
//                System.out.println(this.getClass() + " return objectContact_p2:" + objectContact_p1);
                return new VoltageTerminal(voltageTerminal.getEventElectricity(), objectContact_p1.getMainContact());
            }
