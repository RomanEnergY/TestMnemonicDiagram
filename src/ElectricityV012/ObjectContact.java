...
//        System.out.println(this.getClass() + " contactConnectArrayList:" + this.contactConnectArrayList + " pathElectricCurrent:" + pathElectricCurrent);
        ...
        for (Contact contactConnect : this.contactConnectArrayList) {
            ...
            contactConnect.getArrayListPathElectricCurrents().add(pathElectricCurrentClone);
    ...
    public void electricityOff(EventElectricity eventElectricity, Contact contactStartEventElectricity) {
        ...
        for (Contact contactConnect : this.contactConnectArrayList) {
            ...
            do {
                pathElectricCurrentSize = contactConnect.getArrayListPathElectricCurrents().size();
                for (PathElectricCurrent pathElectricCurrent : contactConnect.getArrayListPathElectricCurrents()) {
                    if (pathElectricCurrent.getEventElectricity().equals(eventElectricity)) {
                        contactConnect.getArrayListPathElectricCurrents().remove(pathElectricCurrent);
                        break;
                    }
                }
            } while (pathElectricCurrentSize == contactConnect.getArrayListPathElectricCurrents().size());
            ...
            if (voltageTerminal != null) {
                ...
                if (!voltageTerminal.getContact().equals(contactConnect)) {
                    ...
                    voltageTerminal.getContact().electricityOff(eventElectricity, contactStartEventElectricity);
                }
            }
        }
