...
/** В данном разделе реализован в метод Generator: public void stop который останавливает генератор
 * и передает данные генератора об останове на контакт генератора и передается событие всем подключенным
 * контактам о снятии напряжения
 *
...
public class TestMnemonicDiagram {
    ...
    private TestMnemonicDiagram(){
        System.out.println("ElectricityV008");
//        Test1();
//        Test2();
//        Test3();
        Test4();
