...
public interface ElectricityObject {
     ...
     *
     * @param contact пердаваемый контакт, схемы соединений
     */
    ArrayList<ContactEventElectricity> mapConnectionContactElectricityObject(EventElectricity eventElectricity, Contact contact);
}
