...
//        this.getContact_p1().getArrayListPathElectricCurrents().add(new PathElectricCurrent(this.eventElectricity));
        System.out.println(this.getClass() + " switchOn():" + this.getContact_p1());
        this.getContact_p1().electricityOn(this.eventElectricity, this.getContact_p1()); // передаем событие
