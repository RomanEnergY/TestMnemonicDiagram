...
public class TestMnemonicDiagram {
    ...
    private void Test1() {
        ...
        l1.getContact_p2().connection(t1.getContact_p1());

        g2.getContact_p1().connection(v2.getContact_p1());
        v2.getContact_p2().connection(l2.getContact_p1());
        l2.getContact_p2().connection(v3.getContact_p2());
        l2.getContact_p2().connection(t2.getContact_p1());

        // тест закольцовка
//        l1.getContact_p2().connection(v4.getContact_p2());
