...
//        System.out.println("ObjectContact:electricityOn eventElectricity:" + eventElectricity + " contact:" + contact);
        // Передаем данные подключенным объектам
        this.electricityObject.mapConnectionContactElectricityObject(eventElectricity, contact);
        for (Contact c: getContactArrayList()) {
            c.electricityOn(eventElectricity);
        }


//        if (this.electricityObject.mapConnectionElectricityObject(contact) != null)
//            this.electricityObject.mapConnectionElectricityObject(contact).electricityOn(eventElectricity);
//
...
//        System.out.println(this.getClass() + ":electricityOff eventElectricity:" + eventElectricity + " contact:" + contact);
...
//        if (this.electricityObject.mapConnectionElectricityObject(contact) != null)
//            this.electricityObject.mapConnectionElectricityObject(contact).electricityOff(eventElectricity);
//
//        for (Contact c: getContactArrayList()) {
//            c.electricityOff(eventElectricity);
//        }
