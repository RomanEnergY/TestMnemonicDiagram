...
public class Generator implements ElectricityObject {
    ...
    public void voltageTerminalAppeared(Contact contactVoltageTerminalAppeared) {
        System.out.println("public void voltageTerminalAppeared(Contact contactVoltageTerminalAppeared): " + this.getClass() + " напряжение появилось " + contactVoltageTerminalAppeared);
    }

    @Override // ElectricityObject
    public void voltageTerminalDisAppeared(Contact contactVoltageTerminalDisAppeared) {
        System.out.println("public void voltageTerminalDisAppeared(Contact contactVoltageTerminalAppeared): " + this.getClass() + " напряжение исчезло полностью " + contactVoltageTerminalDisAppeared);
    }
}
